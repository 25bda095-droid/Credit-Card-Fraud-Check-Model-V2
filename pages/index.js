...
export default function FraudDetectionApp() {
  ...
  useEffect(() => {
    document.title = "Credit Card Fraud Detection System";
  }, []);
    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <header className="relative z-10 border-b border-red-500/20 bg-black/60 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="relative" title="Credit Card Fraud Detection System">
                <Shield className="w-12 h-12 text-red-500" />
                <div className="absolute inset-0 blur-xl bg-red-500/50"></div>
              </div>
              <div>
                ...
                <p className="text-sm text-gray-400">AI-Powered Detection Platform by NeuroNova Team</p>
              </div>
            </div>
            <div className="flex items-center space-x-6">
              <div className="text-right">
      ...
      {/* Rest of the original content here */}
      {/* ...same as your previous UI content... */}
